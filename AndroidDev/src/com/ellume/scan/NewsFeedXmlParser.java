...
/**
 * This class parses XML feeds from school news feed.
...
public class NewsFeedXmlParser {
    ...
    private List<RSSItem> readFeed(XmlPullParser parser) throws XmlPullParserException, IOException {
        ...
        while (parser.next() != XmlPullParser.END_DOCUMENT) {
            ...
            } else if (name.equals("atom:summary")) {
            ...
            if (title != null && link != null) {
                if (!firstItem){
                	RSSItem item = new RSSItem(title, summary, link, pubDate);
                	entries.add(item);
...
/*    private Entry readEntry(XmlPullParser parser) throws XmlPullParserException, IOException {
 ...
 /*   private String readLink(XmlPullParser parser) throws IOException, XmlPullParserException {
    ...
    private String readSummary(XmlPullParser parser) throws IOException, XmlPullParserException {
        parser.require(XmlPullParser.START_TAG, ns, "atom:summary");
        String summary = readText(parser);
        parser.require(XmlPullParser.END_TAG, ns, "atom:summary");
        return summary;
    }
